...
public class Fragment implements Serializable {
	...
	/**
	 * Please only use these fragment parts for traversing, do not add items to
	 * the list itself. Use {@link insertFragmentPart(FragmentPart) } instead,
	 * since it will maintain list ordering.
	 * 
	 * @return
	 */
