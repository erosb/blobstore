...
public class BlobstoreCacheServiceImplTest {
	...
	private void createPartsInFragment(final long fragmentStartPosition,
		...
		for (Interval<Long> interval : intervals) {
			int size = interval.getHigherBound().intValue()
					- interval.getLowerBound().intValue() - 1;
			if (interval.isHigherInclusive()) {
				++size;
			}
			if (interval.isLowerInclusive()) {
				++size;
			}
			FragmentPart newPart = new FragmentPart(interval.getLowerBound(),
	...
	public void testGetBlobParts() {
		createPartsInFragment(0, new Interval[] {
				new Interval<Long>(200l, 400l, true, false),
				new Interval<Long>(600l, 800l, true, false),
				new Interval<Long>(800l, 1024l, true, false) });
		createPartsInFragment(FRAGMENT_SIZE, new Interval[] {
				new Interval<Long>(0l, 76l, true, false),
				new Interval<Long>(76l, 176l, true, false),
				new Interval<Long>(176l, 276l, true, false) });
	...
	public void testStoreBlobPartOneFragmentContaining() {
		...
		createPartsInFragment(FRAGMENT_SIZE,
				new Interval[] { new Interval<Long>(50l, 950l, true, false) });
		List<CacheKey> keyList = keyCache.get(BLOB_ID);
		Assert.assertEquals(1, keyList.size());
	...
	public void testStoreBlobPartOneFragmentOverlapping() {
		...
		long offset = 10l;
		createPartsInFragment(FRAGMENT_SIZE, new Interval[] {
				new Interval<Long>(5l, 20l, true, false),
				new Interval<Long>(25l, 40l, true, false),
				new Interval<Long>(50l, 65l, true, false),
				new Interval<Long>(80l, 95l, true, false),
				new Interval<Long>(98l, 102l, true, false) });
		cacheService.storeBlobPart(BLOB_ID, FRAGMENT_SIZE + offset, newData);
		List<CacheKey> keyList = keyCache.get(BLOB_ID);
		Assert.assertEquals(1, keyList.size());
		CacheKey key = keyList.get(0);
	...
	public void testStoreBlobPartThreeFragments() {
		...
		createPartsInFragment(FRAGMENT_SIZE, new Interval[] {
				new Interval<Long>(60l, 90l, true, false),
				new Interval<Long>(600l, 950l, true, false),
				new Interval<Long>(960l, 1000l, true, false) });
		createPartsInFragment(FRAGMENT_SIZE * 2, new Interval[] {
				new Interval<Long>(300l, 500l, true, false),
				new Interval<Long>(600l, 950l, true, false),
				new Interval<Long>(960l, 1000l, true, false) });
		createPartsInFragment(FRAGMENT_SIZE * 3, new Interval[] {
				new Interval<Long>(0l, 40l, true, false),
				new Interval<Long>(50l, 350l, true, false),
				new Interval<Long>(960l, 1000l, true, false) });
